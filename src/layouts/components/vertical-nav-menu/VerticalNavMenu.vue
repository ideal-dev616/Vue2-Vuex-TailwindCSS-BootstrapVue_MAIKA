      ...
      <!-- <div> -->
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <span class="vx-logo-text text-primary" v-show="isMouseEnter || !reduce" v-if="title"> Menu</span>
          </router-link>
          <!-- /Logo-->

          <!-- Menu Buttons -->
          <div class="feather-icon-container">
            <!-- Close Button -->
            ...
            <template v-else-if="!showCloseButton">
              <feather-icon
                ...
                :icon="reduce ? 'ArrowRightIcon' : 'ArrowLeftIcon'"
